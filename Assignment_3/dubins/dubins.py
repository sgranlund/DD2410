...
def car_evaluate(car, controls, times, verbose=False):
    ...
    # return states, controls, times, final safety, and done
...
class Environment(object):
    ...
    def init_obstacles(self):
        ...
        '''
        Initializes as many obstacles, with 1-2 [m] radius, as possible
        with at least 2 [m] clearance.
        '''

        # obstacle list
        self.obstacles = list()
        # number of unsuccessful obstacles
        first, i = True, 0
        ...
        while i < 20000:
            ...
            # subsequent obstacles
                ...
                for ob in self.obstacles:
                    ...
                    # discard obstacle if not 2 [m] clearance
                    if d < ob.r + r + 1:
                        good = False
                        break
                    # keep testing if clearance is good
                    else:
                        good = True
